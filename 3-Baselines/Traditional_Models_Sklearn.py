...
class base_model(object): 
    ...
    def load_data(self,category=None):
        ...
        self.X_train = np.load('/users/PAS2671/kabir36/ns_project/DAP/data/train_set/X_train_'+CITY+'.npy', allow_pickle=True)[:,0:-1]
            
        self.y_train = np.load('/users/PAS2671/kabir36/ns_project/DAP/data/train_set/y_train_'+CITY+'.npy', allow_pickle=True)
            
        self.X_test = np.load('/users/PAS2671/kabir36/ns_project/DAP/data/train_set/X_test_'+CITY+'.npy', allow_pickle=True)[:,0:-1]
            
        self.y_test = np.load('/users/PAS2671/kabir36/ns_project/DAP/data/train_set/y_test_'+CITY+'.npy', allow_pickle=True)
